...
namespace LiquidsLib.Examples {
	...
	public class ExampleGlobalLiquid : GlobalLiquid {
		public static bool LoadingEnabled = true;
		...
		public override bool? CanMoveLeft(int x, int y, int xMove, int yMove, bool canMoveVanilla) {
			...
			int exampleBlock = TileID.AncientCopperBrick;//ModContent.TileType<ExampleBlock>();
